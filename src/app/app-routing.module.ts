...
// routing işlmelerini burada yaptık, daha önce de componentlerin modülünde gerçekleştirdik, en son burada yapılması gerekiyordu. örneğin www.....com/admin/customer geldiyse aşağıdaki path çalışır ve customer modulüne yönlendirir.
const routes: Routes = [
